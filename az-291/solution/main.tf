...
resource "azurerm_postgresql_server" "example" {
  ...
  administrator_login          = "myadminuser" # These credentials are for testing only (please change!)
  administrator_login_password = "MyPassw0rd" # These credentials are for testing only (please change!)
  version                      = "9.5"
